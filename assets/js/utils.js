async function createLinkPreview(url, container, layout = "auto", width = 380) {
    ...
    try {
        ...
        // Define function to render card layout
        function renderCard(isHorizontal) {
      ...
      `;
        ...
        const handleResize = () => {
            ...
            if (layout === "auto") {
                isHorizontal = window.innerWidth > 768; // tablet & above = horizontal
            } else {
                isHorizontal = layout === "horizontal";
            }

            renderCard(isHorizontal);
        };
